public class OnelineIf {
	public static void main(String[] args) {
		...
		System.out.println("거짓일 경우 실행할 문장2"); // 이렇게 하면 생략된 중괄호는 문장1까지만 포함하기 때문에 일반 문장인 문장2는 if절 거치지 않고 출력
		...
		// (con) ? System.out.println("참 출력") : System.out.println("거짓 출력"); 문장을 대치시키지는 못하고 '값'을 선택할 때 가능
